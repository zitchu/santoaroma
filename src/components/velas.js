  ...
  return (
    ...
    >
      <div className="w-full md:w-[66%] h-screen flex flex-col justify-evenly right-0 absolute">
        <h1 className="quicksand-body text-sm md:text-lg lg:text-2xl h-full flex right-0 relative justify-center items-center bg-azul px-[5%] text-justify leading-6 md:leading-10">
        ...
        <h2 className="quicksand-body text-sm md:text-lg lg:text-2xl h-full flex right-0 relative justify-center items-center bg-azul px-[5%] text-justify leading-6 md:leading-10">

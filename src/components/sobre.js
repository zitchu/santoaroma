...
function Sobre() {
  return (
    <div
      className="bg-verde h-[100%]  w-full text-black text-2xl flex  justify-center items-center"
      style={{
    ...
    >
      <div className="w-full lg:w-[66%] h-screen flex flex-col left-0 absolute justify-evenly items-center bg-rosa ">
        <h1 className="px-[5%] text-justify text-sm md:text-lg lg:text-2xl leading-5 md:leading-10">

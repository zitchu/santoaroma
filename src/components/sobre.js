...
function Sobre() {
  return (
    <div
      className="bg-verde h-screen w-full text-black text-2xl flex justify-center items-center"
      style={{
    ...
    >
      <div className="w-full lg:w-[66%] h-screen flex flex-col left-0 absolute justify-evenly items-center bg-rosa">
        <h1 className="quicksand-body px-[5%] text-justify text-sm md:text-lg lg:text-2xl leading-5 md:leading-10">
          ...
          estou. Para momentos especiais as velas aromáticas têm me acompanhado
        ...
        <div className="relative flex justify-center items-center">
          ...
          <img
            src={Flor2}
            alt="flor2"
            className="w-[15%] absolute right-0 mr-[20%] mt-0 bottom-[10%] hidden md:block"
          />
        </div>
      </div>
    </div>

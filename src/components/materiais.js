...
function Materiais() {
  return (
    <div
      className="h-screen w-full text-black text-2xl flex flex-row justify-evenly items-center"
      style={{
    ...
    >
      <div className="w-full md:w-[50%] h-screen flex flex-col justify-evenly right-0 absolute overflow-auto">
        <h1 className="quicksand-body text-sm md:text-lg lg:text-2xl h-full flex right-0 relative justify-center items-center bg-creme px-[5%] text-justify leading-5 md:leading-10">
        ...
        <h2 className="quicksand-body text-sm md:text-lg lg:text-2xl h-full flex right-0 relative justify-center items-center bg-creme px-[5%] text-justify leading-5 md:leading-10">
